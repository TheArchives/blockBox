...
def implementedByFallback(cls):
    """Return the interfaces implemented for a class' instances
      ...
      an instance:
        ...
        <implementedBy lib.zope.interface.declarations.?>
    ...
    try:
        ...
        # We don't want to depend directly on lib.zope.security in
        # lib.zope.interface, but we'll try to make reasonable
