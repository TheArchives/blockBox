...
class IF0(lib.zope.interface.Interface):
    pass
class IF1(IF0):
    pass

class IB0(lib.zope.interface.Interface):
    pass
class IB1(IB0):
    pass

class IR0(lib.zope.interface.Interface):
    pass
class IR1(IR0):
    pass
...
def test_multi_adapter_w_inherited_and_multiple_registrations():
    ...
    >>> class IX(lib.zope.interface.Interface):
    ...    pass
...
def test_adapter_hook_with_factory_producing_None():
    ...
    ...     lib.zope.interface.implements(IF0)
...
def test_adapter_registry_update_upon_interface_bases_change():
    ...
    ...     factory = lookup(lib.zope.interface.providedBy(ob), iface)
    ...     if factory is None:
    ...         return None
    ...     else:
    ...         return factory(ob)

    >>> lib.zope.interface.interface.adapter_hooks.append(_hook)
    ...
    >>> class IY(lib.zope.interface.Interface):
    ...   pass
    ...
    >>> class Y(object):
    ...  lib.zope.interface.implements(IY)
    ...
    TypeError: ('Could not adapt',
                <lib.zope.interface.tests.test_adapter.X object at ...>,
                <InterfaceClass lib.zope.interface.tests.test_adapter.IY>)

    But after we declare an interface on the class `X`, it should pass:

    >>> lib.zope.interface.classImplementsOnly(X, IX)

    >>> IY(X()) #doctest: +ELLIPSIS
    <lib.zope.interface.tests.test_adapter.Y object at ...>

    >>> hook = lib.zope.interface.interface.adapter_hooks.pop()
    """
...
def test_changing_declarations():
    ...
    >>> class I1(lib.zope.interface.Interface):
    ...     pass
    >>> class I2(lib.zope.interface.Interface):
    ...     pass
    ...
    >>> registry.lookup([lib.zope.interface.implementedBy(C)], I2, '')

    >>> lib.zope.interface.classImplements(C, I1)
...
There was a bug that caused problems if a spec had multiple bases:
    ...
    >>> class I(lib.zope.interface.Interface):
    ...     pass
    >>> class I2(I, I):
    ...     pass
    >>> registry = AdapterRegistry()
...
def test_unregister_cleans_up_empties():
    ...
    >>> class I(lib.zope.interface.Interface):
    ...     pass
    >>> class IP(lib.zope.interface.Interface):
    ...     pass
    >>> class C(object):
    ...     pass
