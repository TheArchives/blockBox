...
def test_getting_spec_for_proxied_builtin_class():
    ...
    We don't want to depend on proxies in this (lib.zope.interface)
    ...
    We'll create an implements specification:
      ...
      >>> impl = lib.zope.interface.declarations.Implements(I1, I2)

    Now, we'll emulate a declaration for a built-in type by putting
    it in BuiltinImplementationSpecifications:

      >>> lib.zope.interface.declarations.BuiltinImplementationSpecifications[
      ...   cls] = impl
    ...
    Of course, we don't want to leave it there. :)
      ...
      >>> del lib.zope.interface.declarations.BuiltinImplementationSpecifications[
      ...   cls]
...
def test_declaration_get():
    ...
    We can get definitions from a declaration:
        ...
        ...    a11 = lib.zope.interface.Attribute('a11')
        ...    a12 = lib.zope.interface.Attribute('a12')
        >>> class I2(lib.zope.interface.Interface):
        ...    a21 = lib.zope.interface.Attribute('a21')
        ...    a22 = lib.zope.interface.Attribute('a22')
        ...    a12 = lib.zope.interface.Attribute('a212')
        >>> class I11(I1):
        ...    a11 = lib.zope.interface.Attribute('a111')

        >>> decl = lib.zope.interface.Declaration(I11, I2)
    ...
    We get None even with no interfaces:
        ...
        >>> decl = lib.zope.interface.Declaration()
        >>> decl.get('a11')
        >>> decl.get('a11', 42)
        42
...
def test_classImplements_after_classImplementsOnly_issue_402():
    """http://www.lib.zope.org/Collectors/Zope3-dev/402
...
def test_provided_by_with_slots():
    ...
    >>> class IFoo(lib.zope.interface.Interface):
    ...     pass
...
def test_suite():
    return unittest.TestSuite((
        ...
        doctest.DocTestSuite("lib.zope.interface.declarations"),
