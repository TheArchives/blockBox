...
class InterfaceTests(unittest.TestCase):
    ...
    def testIssue228(self):
        from lib.zope.interface import Interface
        # Test for http://collector.lib.zope.org/Zope3-dev/228
        if sys.version[0] == '3':
...
def test_description_cache_management():
    """ See https://bugs.launchpad.net/lib.zope.interface/+bug/185974
...
def test_suite():
    ...
    suite.addTest(doctest.DocTestSuite("lib.zope.interface.interface"))
    if sys.version_info >= (2, 4):
