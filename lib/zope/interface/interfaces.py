...
class ISpecification(Interface):
    ...
    def weakref(callback=None):
        ...
        lib.zope.interface package does not require lib.zope.security or
        lib.zope.proxy, it has to be able to coexist with it.
...
class IInterface(ISpecification, IElement):
    ...
    o You assert that your object implement the interfaces.
      ...
      1. Call lib.zope.interface.implements in your class definition.

      2. Call lib.zope.interfaces.directlyProvides on your object.

      3. Call 'lib.zope.interface.classImplements' to assert that instances
