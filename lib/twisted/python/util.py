# -*- test-case-name: lib.twisted.python.test.test_util -*-
...
def getPluginDirs():
    ...
    systemPlugins = os.path.join(os.path.dirname(os.path.dirname(
                            os.path.abspath(lib.twisted.__file__))), 'plugins')
...
def dict(*a, **k):
    import __builtin__
    warnings.warn('lib.twisted.python.util.dict is deprecated.  Use __builtin__.dict instead')
