# -*- test-case-name: lib.twisted.test.test_threadpool -*-
# Copyright (c) 2001-2010 Twisted Matrix Laboratories.
# See LICENSE for details.


"""
lib.twisted.threadpool: a pool of threads to which we dispatch tasks.
...
class ThreadPool:
    ...
    def callInThreadWithCallback(self, onResult, func, *args, **kw):
        ...
        with the return value, or a L{lib.twisted.python.failure.Failure}
    ...
    def dispatchWithCallback(self, owner, callback, errback, func, *args, **kw):
        """
        DEPRECATED: use L{lib.twisted.internet.threads.deferToThread} instead.
        ...
        warnings.warn("dispatchWithCallback() is deprecated since Twisted 8.0, "
                      "use lib.twisted.internet.threads.deferToThread() instead.",
                      DeprecationWarning, stacklevel=2)
        self.callInThread(
