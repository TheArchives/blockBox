# -*- test-case-name: lib.twisted.python.test.test_syslog -*-
...
class SyslogObserver:
	...
	See L{lib.twisted.python.log} for context.
...
def startLogging(prefix='Twisted', options=DEFAULT_OPTIONS,
	...
	other parameters, see L{lib.twisted.python.log.startLoggingWithObserver}.
	"""
