...
"""
Tests for Twisted's deprecation framework, L{lib.twisted.python.deprecate}.
"""
    ...
    def test_getDeprecationWarningString(self):
        ...
        self.assertEqual(
            getDeprecationWarningString(self.test_getDeprecationWarningString,
                                        version),
            "lib.twisted.python.test.test_deprecate.TestDeprecationWarnings."
...
class _MockDeprecatedAttribute(object):
    """
    Mock of L{lib.twisted.python.deprecate._DeprecatedAttribute}.
...
class ModuleProxyTests(TestCase):
    """
    Tests for L{lib.twisted.python.deprecate._ModuleProxy}, which proxies
    ...
    def test_getattrPassthrough(self):
        """
        Getting a normal attribute on a L{lib.twisted.python.deprecate._ModuleProxy}
    ...
    def test_getattrIntercept(self):
        ...
        L{lib.twisted.python.deprecate._ModuleProxy} results in calling the
    ...
    def test_privateAttributes(self):
        """
        Private attributes of L{lib.twisted.python.deprecate._ModuleProxy} are
    ...
    def test_setattr(self):
        """
        Setting attributes on L{lib.twisted.python.deprecate._ModuleProxy} proxies
    ...
    def test_repr(self):
        """
        L{lib.twisted.python.deprecated._ModuleProxy.__repr__} produces a string
...
class DeprecatedAttributeTests(TestCase):
    """
    Tests for L{lib.twisted.python.deprecate._DeprecatedAttribute} and
    L{lib.twisted.python.deprecate.deprecatedModuleAttribute}, which issue
    ...
    def test_deprecatedAttributeHelper(self):
        """
        L{lib.twisted.python.deprecate._DeprecatedAttribute} correctly sets its
    ...
    def test_deprecatedAttribute(self):
        """
        L{lib.twisted.python.deprecate.deprecatedModuleAttribute} wraps a
    ...
    def test_wrappedModule(self):
        ...
        L{lib.twisted.python.deprecate._ModuleProxy} instance but only if it hasn't
