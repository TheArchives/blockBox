...
"""
Tests for L{lib.twisted.python.release} and L{lib.twisted.python._release}.
        ...
        structure = {
            ...
            "twisted": {
                ...
                "web": {
                    "topfiles": {
                        "README": "Hi this is 1.0.0"},
                    "_version.py": genVersion("lib.twisted.web", 1, 0, 0)
                    }}}
        ...
        outStructure = {
            ...
            "twisted": {
                ...
                "web": {
                    "topfiles": {
                        "README": "Hi this is 1.0.2"},
                    "_version.py": genVersion("lib.twisted.web", 1, 0, 2),
                    }}}
            ...
            "twisted": {
                ...
                "web": {
                    "topfiles": {
                        ...
                        "NEWS": webNews},
                    "_version.py": genVersion("lib.twisted.web", 1, 0, 0, 1)
                    }}}
        self.createStructure(root, structure)
...
class VersionWritingTest(TestCase):
    ...
    def test_replaceProjectVersion(self):
        ...
        replaceProjectVersion("test_project",
                              Version("lib.twisted.test_project", 0, 82, 7))
        ns = {'__name___': 'lib.twisted.test_project'}
...
class APIBuilderTestCase(TestCase):
    ...
    def test_buildWithPolicy(self):
        ...
        twistedPath = outputPath.child("lib.twisted.html")
        self.assertTrue(
            twistedPath.exists(),
    ...
    def createFakeTwistedProject(self):
        ...
        self.createStructure(project, {
                ...
                'topfiles': {
                    ...
                    '5.misc': ''},
                'conch': {
                    '_version.py': genVersion("lib.twisted.conch", 3, 4, 5),
                    'topfiles': {
                        'NEWS': 'Old conch news.\n',
                        '7.bugfix': 'Fixed that bug.\n'}},
                'vfs': {
                    '_version.py': genVersion("lib.twisted.vfs", 6, 7, 8),
                    'topfiles': {
                        'NEWS': 'Old vfs news.\n',
            ...
            "twisted":
                {
                    ...
                    "words": {"__init__.py": "import WORDS",
                              "_version.py":
                                  genVersion("lib.twisted.words", 1, 2, 0),
