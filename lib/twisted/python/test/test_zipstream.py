...
"""
Tests for L{lib.twisted.python.zipstream}
"""
import sys
import random
import zipfile
...
class ZipstreamTest(unittest.TestCase):
    """
    Tests for lib.twisted.python.zipstream
    """
    def setUp(self):
        """
    ...
    def test_unzipIter(self):
        """
        L{lib.twisted.python.zipstream.unzipIter} should unzip a file for each
    ...
    def test_unzipIterChunky(self):
        """
        L{lib.twisted.python.zipstream.unzipIterChunky} returns an iterator which
    ...
    def test_unzip(self):
        """
        L{lib.twisted.python.zipstream.unzip} should extract all files from a zip
        archive
        """
        numfiles = 3
    ...
    def test_overwrite(self):
        """
        L{lib.twisted.python.zipstream.unzip} and
        L{lib.twisted.python.zipstream.unzipIter} shouldn't overwrite files unless
