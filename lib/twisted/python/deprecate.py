# -*- test-case-name: lib.twisted.python.test.test_deprecate -*-
# Copyright (c) 2008-2010 Twisted Matrix Laboratories.
# See LICENSE for details.

"""
Deprecation framework for lib.twisted.
...
# Notionally, part of lib.twisted.python.reflect, but defining it there causes a
...
def _fullyQualifiedName(obj):
	...
	return name
# Try to keep it looking like something in lib.twisted.python.reflect.
_fullyQualifiedName.__module__ = 'lib.twisted.python.reflect'
