# -*- test-case-name: lib.twisted.test.test_reflect -*-
...
def funcinfo(function):
    ...
    """
    warnings.warn(
        "[v2.5] Use inspect.getargspec instead of lib.twisted.python.reflect.funcinfo",
        DeprecationWarning,
        stacklevel=2)
...
def namedAny(name):
    ...
    object is 'lib.twisted.python.reflect.namedAny'.
...
def macro(name, filename, source, **identifiers):
    ...
    # shield your eyes!
    sm = sys.modules
    tprm = "lib.twisted.python.reflect.macros"
