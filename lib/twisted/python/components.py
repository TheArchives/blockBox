# -*- test-case-name: lib.twisted.python.test.test_components -*-
...
you need is in the top-level of the lib.zope.interface package, e.g.::
...
L{lib.twisted.python.components.registerAdapter} from this module may be used to
add to Twisted's global adapter registry. 

L{lib.twisted.python.components.proxyForInterface} is a factory for classes
...
def backwardsCompatImplements(klass):
	...
	lib.zope.interface using class to a class wanting old twisted
...
def getRegistry():
	...
	C{lib.zope.interface.adapter.AdapterRegistry} instance.
	"""
