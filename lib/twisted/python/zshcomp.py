# -*- test-case-name: lib.twisted.test.test_zshcomp -*-
...
commands that use lib.twisted.python.usage. This is the stuff that makes pressing
...
class Builder:
	def __init__(self, cmd_name, options, file):
		...
		@type options: C{lib.twisted.usage.Options}
		@param options: The C{lib.twisted.usage.Options} instance defined for
						this command
...
class SubcommandBuilder(Builder):
	"""
	Use this builder for commands that have sub-commands. lib.twisted.python.usage
...
class ArgumentsGenerator:
	...
	def __init__(self, cmd_name, options, file):
		...
		@type options: C{lib.twisted.usage.Options}
		@param options: The C{lib.twisted.usage.Options} instance defined
						for this command
...
generateFor = [('conch', 'lib.twisted.conch.scripts.conch', 'ClientOptions'),
			   ('mktap', 'lib.twisted.scripts.mktap', 'FirstPassOptions'),
			   ('trial', 'lib.twisted.scripts.trial', 'Options'),
			   ('cftp', 'lib.twisted.conch.scripts.cftp', 'ClientOptions'),
			   ('tapconvert', 'lib.twisted.scripts.tapconvert', 'ConvertOptions'),
			   ('twistd', 'lib.twisted.scripts.twistd', 'ServerOptions'),
			   ('ckeygen', 'lib.twisted.conch.scripts.ckeygen', 'GeneralOptions'),
			   ('lore', 'lib.twisted.lore.scripts.lore', 'Options'),
			   ('pyhtmlizer', 'lib.twisted.scripts.htmlizer', 'Options'),
			   ('tap2deb', 'lib.twisted.scripts.tap2deb', 'MyOptions'),
			   ('tkconch', 'lib.twisted.conch.scripts.tkconch', 'GeneralOptions'),
			   ('manhole', 'lib.twisted.scripts.manhole', 'MyOptions'),
			   ('tap2rpm', 'lib.twisted.scripts.tap2rpm', 'MyOptions'),
			   ('websetroot', None, None),
			   ('tkmktap', None, None),
			   ]
# NOTE: the commands using None above are no longer included in lib.twisted.
...
def run():
	...
	if options['install']:
		import twisted
		dir = os.path.join(os.path.dirname(lib.twisted.__file__), "python", "zsh")
