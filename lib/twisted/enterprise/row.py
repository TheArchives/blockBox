...
from lib.twisted.enterprise.util import DBError, NOQUOTE, getKeyColumn, dbTypeMap
...
class RowObject:
	...
	def __init__(self):
		...
		DEPRECATED.
		"""
		warnings.warn("lib.twisted.enterprise.row is deprecated since Twisted 8.0",
