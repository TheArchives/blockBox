...
implement SSL and TLS.  Typical usage of this module looks like this::
	...
	from lib.twisted.internet.ssl import PrivateCertificate
...
class TLSMemoryBIOProtocol(ProtocolWrapper):
	...
	def getHandle(self):
		...
		This is done for the benefit of L{lib.twisted.internet.ssl.Certificate}'s
