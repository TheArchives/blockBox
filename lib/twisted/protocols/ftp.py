...
class FTP(object, basic.LineReceiver, policies.TimeoutMixin):
	...
	@ivar listenFactory: A callable with the signature of
		L{lib.twisted.internet.interfaces.IReactorTCP.listenTCP} which will be used
...
class FTPAnonymousShell(object):
	...
	@type filesystemRoot: L{lib.twisted.python.filepath.FilePath}
...
class FTPRealm(BaseFTPRealm):
	"""
	@type anonymousRoot: L{lib.twisted.python.filepath.FilePath}
