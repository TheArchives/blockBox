...
class LoopingCall:
    ...
    @ivar clock: A provider of
        L{lib.twisted.internet.interfaces.IReactorTime}.  The default is
        L{lib.twisted.internet.reactor}. Feel free to set this to
...
class Clock:
    ...
    def callLater(self, when, what, *a, **kw):
        """
        See L{lib.twisted.internet.interfaces.IReactorTime.callLater}.
        """
    ...
    def getDelayedCalls(self):
        """
        See L{lib.twisted.internet.interfaces.IReactorTime.getDelayedCalls}
        """
        return self.calls
