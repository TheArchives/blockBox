...
class _SIGCHLDWaker(_FDWaker):
    ...
    @see: L{lib.twisted.internet._signals}
    """
    def __init__(self, reactor):
...
class PosixReactorBase(_SignalReactorMixin, ReactorBase):
    ...
    def connectUNIX(self, address, factory, timeout=30, checkPID=0):
        """@see: lib.twisted.internet.interfaces.IReactorUNIX.connectUNIX
        """
    ...
    def listenUNIX(self, address, factory, backlog=50, mode=0666, wantPID=0):
        """
        @see: lib.twisted.internet.interfaces.IReactorUNIX.listenUNIX
        """
        assert unixEnabled, "UNIX support is not present"
    ...
    def listenTCP(self, port, factory, backlog=50, interface=''):
        """@see: lib.twisted.internet.interfaces.IReactorTCP.listenTCP
        """
    ...
    def connectTCP(self, host, port, factory, timeout=30, bindAddress=None):
        """@see: lib.twisted.internet.interfaces.IReactorTCP.connectTCP
        """
    ...
    def connectSSL(self, host, port, factory, contextFactory, timeout=30, bindAddress=None):
        """@see: lib.twisted.internet.interfaces.IReactorSSL.connectSSL
        """
    ...
    def listenSSL(self, port, factory, contextFactory, backlog=50, interface=''):
        """@see: lib.twisted.internet.interfaces.IReactorSSL.listenSSL
        """
        assert sslEnabled, "SSL support is not present"
