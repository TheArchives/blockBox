...
from lib.twisted.python.util import setIDFunction
from lib.twisted.internet.interfaces import IReactorTime, IReactorThreads
from lib.twisted.internet.error import DNSLookupError
from lib.twisted.internet.base import ThreadedResolver, DelayedCall
