...
from lib.twisted.internet.defer import CancelledError
from lib.twisted.internet.protocol import Protocol, ClientCreator
from lib.twisted.internet.task import Clock
from lib.twisted.trial.unittest import TestCase
from lib.twisted.test.proto_helpers import MemoryReactor, StringTransport
