...
from lib.twisted.internet import error, interfaces
from lib.twisted.internet import endpoints
from lib.twisted.internet.address import IPv4Address, UNIXAddress
from lib.twisted.internet.protocol import ClientFactory, Protocol
from lib.twisted.test.proto_helpers import MemoryReactor, RaisingMemoryReactor
from lib.twisted.python.failure import Failure

try:
    from lib.twisted.test.test_sslverify import makeCertificate
    from lib.twisted.internet.ssl import CertificateOptions
    skipSSL = False
except ImportError:
