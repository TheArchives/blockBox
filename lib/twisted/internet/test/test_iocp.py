from lib.twisted.internet.protocol import ServerFactory, Protocol, ClientCreator
from lib.twisted.internet.defer import DeferredList, maybeDeferred, Deferred
...
class IOCPReactorTestCase(unittest.TestCase):
    def test_noPendingTimerEvents(self):
        ...
        events.
        """
        from lib.twisted.internet.iocpreactor.reactor import IOCPReactor
        ir = IOCPReactor()
        ir.wakeUp()
