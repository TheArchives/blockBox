...
from lib.twisted.internet.fdesc import setNonBlocking
from lib.twisted.internet._signals import installHandler, isDefaultHandler
from lib.twisted.internet._signals import _extInstallHandler, _extIsDefaultHandler
from lib.twisted.internet._signals import _installHandlerUsingSetWakeup, \
...
class ExtensionSIGCHLDTests(SIGCHLDTestsMixin, TestCase):
    ...
    """
    try:
        import lib.twisted.internet._sigchld
    except ImportError:
