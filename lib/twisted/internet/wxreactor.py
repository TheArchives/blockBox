...
"""
This module provides wxPython event loop support for lib.twisted.

In order to use this support, simply do the following::

	|  from lib.twisted.internet import wxreactor
	|  wxreactor.install()
...
Then use lib.twisted.internet APIs as usual. Stop the event loop using
