# -*- test-case-name: lib.twisted.internet.test.test_core -*-
...
from lib.twisted.internet.posixbase import PosixReactorBase, _Waker
from lib.twisted.internet.selectreactor import _NO_FILENO, _NO_FILEDESC
	...
	def _watchFD(self, fd, descr, flag):
		...
		if fd in self._fdmap:
			...
			CFSocketSetSocketFlags(
				...
				# SO_ERROR and thereby break lib.twisted.internet.tcp.BaseClient,
