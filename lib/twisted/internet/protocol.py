...
lib.twisted.  The Protocol class contains some introductory material.
...
class Factory:
	...
	def buildProtocol(self, addr):
		...
		@param addr: an object implementing L{lib.twisted.internet.interfaces.IAddress}
		"""
		p = self.protocol()
		p.factory = self
		return p
...
class BaseProtocol:
	...
	L{lib.twisted.internet.interfaces.ITransport}.

	Some subclasses exist already to help you write common types of protocols:
	see the L{lib.twisted.protocols.basic} module for a few of them.
	"""
...
class DatagramProtocol(AbstractDatagramProtocol):
	...
	@type transport: C{NoneType} or
		L{IUDPTransport<lib.twisted.internet.interfaces.IUDPTransport>} provider
