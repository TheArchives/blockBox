...
from lib.twisted.plugin import getPlugins
from lib.twisted.internet.interfaces import IStreamServerEndpointStringParser
from lib.twisted.internet.interfaces import IStreamClientEndpointStringParser
...
def serverFromString(reactor, description):
	...
	@rtype: L{IStreamServerEndpoint<lib.twisted.internet.interfaces.IStreamServerEndpoint>}
