# -*- test-case-name: lib.twisted.test.test_sslverify -*-
...
from lib.twisted.python import reflect, util
from lib.twisted.python.hashlib import md5
from lib.twisted.internet.defer import Deferred
from lib.twisted.internet.error import VerifyError, CertificateError
