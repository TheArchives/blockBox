# -*- test-case-name: lib.twisted.test.test_process,lib.twisted.internet.test.test_process -*-
...
SIGCHLD is received.  See L{lib.twisted.internet.posixbase._SIGCHLDWaker}
...
the L{lib.twisted.internet._sigchld} extension module provides similar
functionality.
...
from lib.twisted.python.log import msg

try:
	from lib.twisted.internet._sigchld import installHandler as _extInstallHandler, \
...
def _cannotInstallHandler(fd):
	...
	neither the L{lib.twisted.internet._sigchld} extension nor the standard
