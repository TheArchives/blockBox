# -*- test-case-name: lib.twisted.words.test.test_xmlstream -*-
#
...
from lib.twisted.words.xish import domish, utility
...
class BootstrapMixin(object):
	...
	L{IProtocolFactory<lib.twisted.internet.interfaces.IProtocolFactory>} to make
