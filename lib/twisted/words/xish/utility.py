# -*- test-case-name: lib.twisted.words.test.test_xishutil -*-
#
...
from lib.twisted.words.xish import xpath
...
class EventDispatcher:
	...
	be an L{Element<lib.twisted.words.xish.domish.Element>} instance, which is
	...
	is not restricted to L{Element<lib.twisted.words.xish.domish.Element>}, but can
	be anything.
	...
	def dispatch(self, obj, event=None):
		...
		L{Element<lib.twisted.words.xish.domish.Element>}. Otherwise, C{event}
...
class XmlPipe(object):
	...
	Unlike Jabber
	L{XmlStream<lib.twisted.words.protocols.jabber.xmlstream.XmlStream>}s, the sink
