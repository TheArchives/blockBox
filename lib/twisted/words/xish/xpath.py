# -*- test-case-name: lib.twisted.words.test.test_xpath -*-
#
...
L{domish.Element<lib.twisted.words.xish.domish.Element>} instances against
...
class XPathQuery:
	def __init__(self, queryStr):
		...
		from lib.twisted.words.xish.xpathparser import parse
