# -*- test-case-name: lib.twisted.words.test.test_domish -*-
...
from lib.zope.interface import implements, Interface, Attribute
...
class Element(object):
	...
	proceeds as expected:
	  ...
	  <lib.twisted.words.xish.domish.Element object at 0x83002ac>
	  >>> root.toXml()
	...
	object C{message} created like:
	  ...
	  <lib.twisted.words.xish.domish.Element object at 0x8276e8c>
	  >>> message.toXml()
	...
	clear:
	  ...
	  <lib.twisted.words.xish.domish.Element object at 0x8276fac>
	  >>> message.toXml()
...
try:
	from lib.twisted.web import sux
except:
