...
class IProtocolPlugin(Interface):
	...
	def getFactory(realm, portal):
		...
		@param realm: An object providing C{lib.twisted.cred.portal.IRealm} and
		C{IChatService}, with which service information should be looked up.

		@param portal: An object providing C{lib.twisted.cred.portal.IPortal},
...
class IChatService(Interface):
	...
	def createUser(name):
		...
		with fails with L{lib.twisted.words.ewords.DuplicateUser} if a
