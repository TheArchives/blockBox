# -*- test-case-name: lib.twisted.words.test.test_basechat -*-
...
from lib.twisted.words.im.locals import OFFLINE, ONLINE, AWAY
...
class Conversation:
	...
	def sendText(self, text):
		...
		@returntype: L{Deferred<lib.twisted.internet.defer.Deferred>}
		"""
