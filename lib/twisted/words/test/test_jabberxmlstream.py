...
from lib.zope.interface.verify import verifyObject

from lib.twisted.internet import defer, task
from lib.twisted.internet.error import ConnectionLost
from lib.twisted.internet.interfaces import IProtocolFactory
from lib.twisted.test import proto_helpers
from lib.twisted.words.test.test_xmlstream import GenericXmlStreamFactoryTestsMixin
from lib.twisted.words.xish import domish
from lib.twisted.words.protocols.jabber import error, ijabber, jid, xmlstream
