...
try:
    ...
    from lib.twisted.web import client
except ImportError:
...
from lib.twisted.protocols import loopback
from lib.twisted.internet.defer import Deferred
from lib.twisted.trial import unittest
from lib.twisted.test.proto_helpers import StringTransport, StringIOWithoutClosing
