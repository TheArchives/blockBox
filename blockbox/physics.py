...
CHR_RED_FLOWER = chr(BLOCK_RED_FLOWER)
CHR_YELLOW_FLOWER = chr(BLOCK_YELLOW_FLOWER)
CHR_RED_MUSHROOM = chr(BLOCK_RED_MUSHROOM)
CHR_BROWN_MUSHROOM = chr(BLOCK_BROWN_MUSHROOM)
CHR_SHRUB = chr(BLOCK_SHRUB)
CHR_TRUNK = chr(BLOCK_TRUNK)
CHR_OBSIDIAN = chr(BLOCK_OBSIDIAN)
